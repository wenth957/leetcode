...
def main():
    # 定义chromedriver路径
    driver_path = r'C:\Users\wang\AppData\Local\Google\Chrome\Application'
    # 获取chrome浏览器驱动
    ...
    while True:
        # 输入手机号
        driver.find_element_by_class_name("nw-input").send_keys("19136160845")
        # 输入密码
        driver.find_element_by_class_name("input").send_keys("baby1234")
        # 点击登录按钮
