...
setwd("days_100\\VaR\\Santander-Product-Recommendation-master\\Data")
...
# Test column 11
table(train[[11]]) # No issue valu_count
...
numIdsTrain <- !train[[12]] %in% c("", "P") # 是否是P值
train[[12]][numIdsTrain] <- as.numeric(train[[12]][numIdsTrain])# 转换成数字特征
table(train[[12]])
